<x-app-layout title="{{ __('Create Auto Report') }}">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">{{ __('Create Auto Report') }}</span>
                    </div>
                    <div class="card-body">
                        <form id="autoReportForm" method="POST" action="{{ route('auto-reports.store') }}" role="form"
