...
$tractorCount = Tractor::whereIn('id', $tractorIds)->count();
$tractors = Tractor::whereIn('id', $tractorIds)->latest('id')->take(5)->get();

$deviceCount = Device::whereIn('id', $deviceIds)->count();
$devices = Device::whereIn('id', $deviceIds)->latest('id')
->take(5)
->get();
$bookingCount = TractorBooking::whereIn('tractor_id',$tractorIds)->orWhereIn('device_id',$deviceIds)->where('state_id',
TractorBooking::STATE_ACTIVE)->count();
$bookings = TractorBooking::whereIn('tractor_id',$tractorIds)->orWhereIn('device_id',$deviceIds)->where('state_id',
TractorBooking::STATE_ACTIVE)
->latest('id')
->take(5)
->get();
$feedbackCount = FarmerFeedback::whereIn('tractor_id',$tractorIds)->where('state_id',
TractorBooking::STATE_ACTIVE)->count();
$farmerFeedbacks = FarmerFeedback::whereIn('tractor_id',$tractorIds)->where('state_id', TractorBooking::STATE_ACTIVE)
->latest('id')
->take(5)
->get();

$groupCount = TractorGroup::whereIn('id',$assignedGroups)->count();
$tractorGroups = TractorGroup::whereIn('id',$assignedGroups)->latest('id')
->take(5)
->get();

$userCount = User::whereIn('id',$userIds )->whereNotIn('role_id',
[User::ROLE_ADMIN,User::ROLE_GOVERNMENT,User::ROLE_SYSTEM_ADMIN])->count();
$users = User::whereIn('id',$userIds )->whereNotIn('role_id',
[User::ROLE_ADMIN,User::ROLE_GOVERNMENT,User::ROLE_SYSTEM_ADMIN])
->latest('id')
->take(5)
->get();
@endphp
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            <div class="text-white">
                                <h2 class="mb-0 number-font">{{ $tractorCount }}</h2>
                                <p class="text-white mb-0">Tractor{{ $tractorCount > 1 ? 's' : '' }} </p>
                            </div>
                            <div class="ms-auto"> <i class="fa-solid fa-tractor text-white fs-30 me-2 mt-2"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <a href="{{ route('devices.index') }}">
                <div class="card img-card box-secondary-shadow border-0">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            <div class="text-white">
                                <h2 class="mb-0 number-font">{{ $deviceCount }}</h2>
                                <p class="text-white mb-0">Device{{ $deviceCount > 1 ? 's' : '' }} </p>
                            </div>
                            <div class="ms-auto"> <i class="fa-solid fa-mobile-button text-white fs-30 me-2 mt-2"></i>
                            </div>
                        </div>
                    </div>
                </div>
