                    ...
                    <tbody>
                        <tr>
                            <td style="text-align: center; padding: 20px 0;background: #f4f4f4;">
                                <h1 style="color: rgba(76, 175, 80, 1); font-size: 24px; margin: 0">{{ $ticketTitle }}</h1>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 20px 20px 0 20px; font-size: 16px; color: rgba(51, 51, 51, 1);">
                                ...
                                @if ($ticket->conclusion)
                                    <p> <span style="font-weight: bold; font-size: 18px; margin-top: 20px;">Conclusion: </span><span style="margin: 0;">{!! $ticket->conclusion !!}</span></p>
