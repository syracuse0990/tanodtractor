...
<x-app-layout>
            ...
            <div class="card  img-card box-secondary-shadow border-0">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto"> <i class="fa fa-bar-chart text-white fs-30 me-2 mt-2"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card img-card box-info-shadow border-0">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto"> <i class="fa fa-cart-plus text-white fs-30 me-2 mt-2"></i>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- graph design  -->
    <div class="row">
        <div class="col-md-5 pie-chart-wrapper h-100 mb-3">
            <div class="card">
                <div class="card-header bg-transparent">
                    <h2 class="card-title mb-0 fw-500">Orders</h2>
                </div>
                <div class="card-body mx-auto py-4">
                    <img src="{{ asset('assets/img/piechart2.png') }}" alt="logo">
                </div>
            </div>
        </div>
        <div class="col-md-7  pie-chart-wrapper  mb-3">
            <div class="card">
                <div class="card-header bg-transparent">
                    <h2 class="card-title mb-0 fw-500">Total Transactions</h2>
                </div>
                <div class="card-body mx-auto">
                    <img src="{{ asset('assets/img/bargraph3.png') }}" alt="logo">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0 fw-500">Product Sales</h3>
                </div>
                <div class="card-body">
                    <div class="row align-items-center mb-3">
                        ...
                        <div class="col-sm-12 col-md-6 text-right">
                            <div class="ms-auto search-filter-box">
                                ...
                                <table id="data-table" class="table table-bordered mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="mb-0 fs-14">Emily Lewis</h6>
                                                <span class="fs-12 text-muted">emily@gmail.com</span>
                                            </td>
                                            <td class="text-muted">19-11-2020 </td>
                                            <td><span class="badge fw-normal bg-danger rounded-3">
                                                    Cancel
                                                </span></td>
                                            <td class="text-muted">$9.321.2</td>

                                            <td class="action-btn">
                                                <a class="btn primary text-primary btn-sm me-2 rounded-3">
                                                    <i class="fa-solid fa-pen"></i>
                                                </a>
                                                <a class="btn danger text-danger btn-sm rounded-3">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-muted">19-11-2020 </td>
                                            <td><span class="badge fw-normal bg-success rounded-3">
                                                    Success
                                                </span></td>
                                            <td class="text-muted">$9.321.2</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-muted">19-11-2020 </td>
                                            <td><span class="badge fw-normal bg-primary rounded-3">
                                                    Pending
                                                </span></td>
                                            <td class="text-muted">$9.321.2</td>
